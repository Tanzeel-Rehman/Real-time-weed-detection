   ...
   public class Compass
    {
        public static Bitmap DrawCompass(double degree, double pitch, double maxpitch, double tilt, double maxtilt, Size s)
        {
                ...
                Bitmap result=null;
                SolidBrush drawBrushWhite = new SolidBrush(Color.FromArgb(220, 255, 255));
                SolidBrush drawBrushRed = new SolidBrush(Color.FromArgb(220, 255, 0, 0));
                SolidBrush drawBrushOrange = new SolidBrush(Color.FromArgb(240, 255, 150, 0));
                SolidBrush drawBrushBlue = new SolidBrush(Color.FromArgb(150, 0, 250, 255));
